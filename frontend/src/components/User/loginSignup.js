...
const LoginSignup = () => {
  ...
  const registerSubmit = async (e) => {
   ...
   console.log(age, name, email, password, avatar);
    myForm.set('age', age.toString());
    ...
    <Fragment>
        ...
        <div className="container">
          <div className="main">
            ...
            <form ref={registerTab} encType="multipart/form-data" onSubmit={registerSubmit} autoComplete='false' id="formid">
            ...
            <form className="login_form" ref={loginTab} onSubmit={loginSubmit}>
                ...
                <input
                  ...
                  name="loginEmail" // Add name attribute
                ...
                <input
                  ...
                  name="loginPassword" // Add name attribute
